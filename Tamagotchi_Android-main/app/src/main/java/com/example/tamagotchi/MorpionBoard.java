...
public class MorpionBoard extends View {
    private int taille;
    ...
    public MorpionBoard(Context context, int taille, List<Pion> historique) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(solution!=null) {
            ...
            canvas.drawText(((vainqueur)?"T'as perdu, T'es trop nul(le)":"T'as gagné, T'es trop fort(e)"), w/2, h/2, pVainqueur);
        }
    }
}
