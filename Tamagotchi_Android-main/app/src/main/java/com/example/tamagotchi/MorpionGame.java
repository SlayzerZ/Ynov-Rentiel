...
public class MorpionGame extends AppCompatActivity implements View.OnTouchListener {
    ...
    public void addPion2(boolean j) {
        ...
        do {
           ...
           // historique.add(new Pion(x, y, j));
            for(Pion c : historique){
                if(c.x==N1.getNumber() && c.y==N2.getNumber()){
                    same = 1;
                    break;
                }
                same = 0;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if(motionEvent.getAction()==MotionEvent.ACTION_UP) {
            int a = (int)(motionEvent.getX());
            int b = (int)(motionEvent.getY());
            int x = (a*taille/plateau.getWidth());
            int y = (b*taille/plateau.getHeight());
           // Le joueur joue;
            if(addPion(x, y, joueurCourant)) {
                if (!estFini(x, y)) {
                    ...
                    if (coupJ != coupT){
                        ...
                        if (!estFini(N1.getNumber(), N2.getNumber())) {
                            joueurCourant = !joueurCourant;
                        }
                    }
                }
            ...
            if(c>=taille) {
                ...
                if (joueurCourant){
                    try {
                        ...
                        SecondActivity.Tama.setHappy(SecondActivity.Tama.getHappy() -40);
                    ...
                    try {
                        ...
                        SecondActivity.setMoney(money);
                        SecondActivity.Tama.setHunger(SecondActivity.Tama.getHunger() - coupJ);
                        SecondActivity.Tama.setHappy(SecondActivity.Tama.getHappy() +10);
                        //Intent nextscreen = new Intent(this, SecondActivity.class);
                        finish();
                        //startActivity(nextscreen);
                    } catch (Exception e){
                ...
                try {
                    ...
                    SecondActivity.setMoney(money);
                    SecondActivity.Tama.setHunger(SecondActivity.Tama.getHunger() - coupJ/2);
                    SecondActivity.Tama.setHappy(SecondActivity.Tama.getHappy() -10);
                    //Intent nextscreen = new Intent(this, SecondActivity.class);
                    finish();
                    //startActivity(nextscreen);
